...
class _SetupProfileScreenState extends State<SetupProfileScreen> {
  ...
  Future<void> saveProfile() async {
    ...
    try {
      ...
      // Save to local provider for immediate use
      if (!mounted) return;
      final stepProvider = Provider.of<StepProvider>(context, listen: false);
          ...
          ? Padding(
              ...
              child: ListView(
                children: [
                  ...
                  _buildInputField(
                      "Weight (kg)", weightC, TextInputType.number),
                  _buildInputField(
                      "Height (cm)", heightC, TextInputType.number),
                  _buildInputField(
                      "Daily Step Goal", stepGoalC, TextInputType.number),
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: GoogleFonts.poppins(
            color: AppColors.textPrimary,
            fontWeight:
                selectedGender == value ? FontWeight.w600 : FontWeight.w400,
          ),
        ),
      ),
    );
